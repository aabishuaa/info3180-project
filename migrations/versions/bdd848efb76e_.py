...
Revision ID: bdd848efb76e
Revises: 
Create Date: 2025-04-28 22:39:38.819002
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['fav_user_id_fk'], ['profile.id'], ),
    sa.ForeignKeyConstraint(['user_id_fk'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
